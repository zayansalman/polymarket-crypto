...
- Zayan expected reversion to fade through the hour; the six-month fit found it grows, and
  part of that may be volatility differing by quarter of the hour (an open review finding).
  The lag-kernel reversal is documented in the literature; its change by hour position is not.
