...
``ems/dashboard/panels/``. Each panel is a pure (data, context) →
...
from ems.marketdata import hub as marketdata_hub
...
async def fade_1h_data() -> dict[str, Any]:
    ...
    """
    from ems.fade_1h_momentum_15m import ledger as _fade_ledger
