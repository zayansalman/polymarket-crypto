...
The card shows the whole ``ems.inventory`` list, grouped by status,
...
def _row_html(family: _inv.Family, is_on: bool, live: dict[str, Any] | None) -> str:
    ...
    return (
        ...
        f"{escape(family.label)}"
        f"<a class='strategy-doc-link' href='/strategy-docs/{escape(family.key)}' "
        "target='_blank' rel='noopener'>docs</a></span>"
