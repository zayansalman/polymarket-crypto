...
(``ems/strategy_docs.py``), so the card cannot say something the
...
from ems.strategy_docs import GLANCE_PARTS
from ems.dashboard.docs_view import render_markdown
