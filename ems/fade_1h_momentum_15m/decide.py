...
if TYPE_CHECKING:  # the hook only reads Inputs; importing it at runtime is not needed
    from ems.fade_1h_momentum_15m.inputs import Inputs
...
def state_from_inputs(inputs: Inputs, spot_feed: str = "chainlink") -> ModelState:
    """The model's view of live :class:`~ems.fade_1h_momentum_15m.inputs.Inputs`.
...
def decide(
    ...
    ``inputs``: this pass's :class:`~ems.fade_1h_momentum_15m.inputs.Inputs` for
